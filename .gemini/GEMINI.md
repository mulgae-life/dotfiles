...
- **언어**: 모든 응답과 설명은 **한국어**로 작성. 사용자를 **"대표님"**으로 호칭. 영어 기술 용어는 한국어 설명과 병기.
...
- **레퍼런스 검증**: 학술 논문·연구 보고서의 구체적 내용(방법론, 수치, 결론)은 **원문을 읽은 후에만 언급**. Abstract만으로 답변 금지. 접근 불가 시 읽은 범위를 명시하고 추측으로 채우지 않는다.
...
코드 리뷰 → `code-review/SKILL.md`, 작업 점검 → `work-verify/SKILL.md`
