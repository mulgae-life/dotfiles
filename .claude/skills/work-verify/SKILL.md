...
문서·리포트·계획서 등 한국어 산문이 포함된 모든 산출물에 적용합니다. 상세 기준은 `.claude/rules/communication.md`를 정답으로 사용합니다.

##### AI스러운 문체
- [ ] **상투어**: "물론입니다", "성공적으로", "완벽하게", "다양한", "효과적으로", "원활하게" 등 내용 없는 수식어가 없는가?
- [ ] **약화체 남발**: 근거가 있는데도 "~인 것 같습니다", "~로 보입니다"로 흐리지 않았는가?
- [ ] **사족·과잉 겸양**: "감사합니다", "도움이 되셨으면", "~점 유의하세요" 류 마무리 사족이 없는가?
- [ ] **구조 강박**: 3문장이면 될 내용에 헤더/불릿/표를 만들지 않았는가? 항목 1-2개를 불릿으로 나열하지 않았는가?

##### 어색한 한국어 표현
- [ ] **번역체·직역**: "~하는 것을 확인할 수 있습니다", "~를 통해 ~가 가능합니다", "~에 의해 ~됩니다"(수동태 직역)가 없는가?
- [ ] **이중 피동·명사문 남발**: "~되어지다", "~에 대한 ~의 ~" 식 명사 연쇄가 없는가?
- [ ] **가능형 남발**: 단정할 내용을 "~할 수 있습니다"로 돌려 말하지 않았는가?

##### 용어 표준성
- [ ] **표준 용어 사용**: 업계 표준 용어를 사용했는가? (임의 번역·신조어 금지 — 예: "스트리밍"을 "흐름 전송"으로 쓰지 않기)
- [ ] **용어 일관성**: 같은 개념에 문서 전체에서 한 용어만 사용했는가? (예: "구독"/"서브스크립션" 혼용 금지)
