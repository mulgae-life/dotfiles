---
name: work-verify
description: 작업 완료 후 결과물을 빠르게 점검합니다. 코드, 문서, 리포트, 계획서 등 모든 작업 유형을 지원합니다. 잘못된 부분, 누락 사항, 영향도를 확인합니다. code-review(심층 리포트)와 달리 빠른 체크리스트 기반 점검에 특화되어 있습니다. "점검해줘", "확인해줘", "빠뜨린 거 없는지 봐줘", "커밋 전에 확인해줘" 등의 요청에 트리거.
---
