---
name: code-review
description: 심각도 등급이 포함된 심층 코드 리뷰 리포트 작성. PR 리뷰, 코드 품질 점검, 보안 취약점 탐색, 리팩토링 전 현황 분석, 코드 변경 영향도 분석 시 사용. code-verify(빠른 점검)와 달리 체계적인 문서화된 리포트를 생성합니다. "코드 리뷰해줘", "리뷰 리포트 작성해줘", "코드 품질 분석해줘", "PR 검토해줘" 등의 요청에 트리거.
---
