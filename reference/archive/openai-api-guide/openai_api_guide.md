...
> **상태**: GPT-5 초기 세대 공식 문서 스냅샷입니다. 최신 GPT-5.6 모델·추론 강도·persisted reasoning·Pro·PTC·캐싱 기준은 [Using GPT-5.6](../../openai-api-guide/openai_api_latest_model_gpt5.6.md)과 [GPT-5.6 Prompting Guide](../../openai-prompt-guide/gpt-5.6-prompt-guide.md)를 우선 적용합니다. 아래의 `low|medium|high` 열거와 reasoning 보존 설명을 GPT-5.6 전체 사양으로 해석하지 않습니다.
