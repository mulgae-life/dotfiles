...
Overall, the agreement seems standard. The indemnification and liability clauses
are typical, and we maintain our IP rights.
```
...
```
I've reviewed the software licensing agreement, and I have serious concerns that
could expose our company to significant risks:
...
1. Indemnification (Section 8):
   ...
   - Recommendation: Reject. Limit our indemnity to claims arising from our violation
     of the agreement.

2. Limitation of Liability (Section 9):
   - Critical Issue: Damages capped at $500, including direct damages.
   - Risk: Grossly inadequate. A critical failure in our data infrastructure could
     cost us millions in lost revenue and reputational damage.
   - Recommendation: Reject. Negotiate for cap at 12 months of fees for direct damages,
     and carve-outs for data breaches.
...
Professional Opinion: Do not sign this agreement. It is grossly unfavorable and
exposes us to unacceptable levels of risk. If the vendor refuses to renegotiate
these terms, I strongly advise exploring alternative providers or accelerating our
in-house solution. The potential costs of proceeding with this agreement far outweigh
...
Overall, financials look strong with revenue growth and healthy margins. Increased
R&D spending is impacting profitability but could pay off long-term. Maintain
current course.
```
...
**Prompt:**
```
system: You are the CFO of a high-growth B2B SaaS company.

user: We're in a board meeting discussing our Q2 financials:
<data>{{FINANCIALS}}</data>

Analyze key trends, flag concerns, and recommend strategic actions. Our investors
want aggressive growth but are wary of our burn rate.
```
...
Strategic Stance: We're threading the needle between growth and burn. Enterprise
focus is our growth engine—invest there. But watch SMB churn; it could bleed into
enterprise. Our AI bet is sound, but we must convert it to ARR by Q4, or we cut
R&D by 30%.
...
❌ Vague: "You are a data analyst"
✅ Specific: "You are a senior data scientist at a Fortune 500 healthcare company, specializing in patient outcome analysis"

### Include Context

```
You are a seasoned CFO of a high-growth B2B SaaS startup. You've successfully
led two companies through Series B funding rounds. You value:
- Data-driven decision making
- Balancing growth with financial discipline
- Clear communication to non-financial stakeholders
```

### Combine with Expertise Areas

```
You are a cybersecurity consultant with 15 years of experience in:
...
- Always quantify risks when possible
```

## Best Practices

1. **Put role in system prompt** - Not in the user message
2. **Be specific about expertise** - "CFO" vs "CFO of high-growth SaaS"
3. **Define communication style** - Brevity, formality, technical depth
4. **Set boundaries** - What the role should/shouldn't do
5. **Combine with examples** - Show the role in action
6. **Experiment** - Different roles can unlock different insights

## Common Roles

- **Domain experts**: Doctor, lawyer, data scientist, engineer
- **Business roles**: CFO, CMO, CEO, product manager
- **Specialized experts**: "Cybersecurity consultant specializing in healthcare compliance"
- **Creative roles**: Copywriter, content strategist, UX designer
- **Analyst roles**: Financial analyst, business analyst, data analyst
